...
train_df = load_supervised_data.get_data("train", "our_data").sample(frac=1)
...
validation_seperated = load_supervised_data.get_data_by_difficulty_and_origin("val", "our_data")

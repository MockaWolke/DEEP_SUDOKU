...
args.data_set = "comp_our_data"


start_time = time.time()

RUNNAME = f"Random_Data_bigger_{args.model}_{start_time}"
...
validation_seperated = get_data_by_difficulty_and_origin("val", "comp_our_data")
